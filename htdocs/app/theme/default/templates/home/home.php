<?php $this->display( 'header' );  ?>
	...
	<header>
		<div class="constrain">
			...
			<h2>Creating friendly and effective solutions to human problems using the Internet.</h2>
		...
		<div class="constrain">
			<aside>
				<ul class="contact unstyled clearfix">
					...
					<li><a href="http://twitter.com/sgsibelle"><i class="ss-social ss-twitter"></i> <span class="title">@sgsibelle</span></a></li>
				</ul>
			</aside>
			<section>
			...
			<section>
				...
				<dl class="projects">
					...
					<dt>Projectionist at <a href="http://rooftopcinema.com.au">Rooftop Cinema</a><dt><dd>Running and screening movies at the Rooftop Cinema.</dd>
				</ul>
			</section>
		</div>
	</article>
